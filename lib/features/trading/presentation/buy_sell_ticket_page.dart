...
class _BuySellTicketPageState extends State<BuySellTicketPage> {
  ...
  void initState() {
    super.initState();
    _ticker = ServiceLocator.instance.marketDataService.tickerFor(
      widget.stock.symbol,
    );
  }
          ...
          children: <Widget>[
            ...
            ValueListenableBuilder<PriceTick>(
              ...
              builder: (BuildContext context, PriceTick tick, _) {
                final Money total =
                    tick.price * (_quantity < 0 ? 0 : _quantity);
                final Color changeColor = MarketColors.forChange(
                  tick.changeSign,
                );
            ...
            ElevatedButton(
              ...
              child: _submitting
                  ...
                  : Text(
                      _side == OrderSide.buy ? 'Confirm Buy' : 'Confirm Sell',
                    ),
            ),
          ],
        ),
